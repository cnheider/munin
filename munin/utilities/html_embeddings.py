...
def generate_metric_table(truths: Sequence,
                          predictions: Sequence,
                          categories: Sequence,
                          decimals: int = 1) -> Sequence[MetricEntry]:
  """
...
def generate_math_html(equation: str = "e^x",
                       inline: bool = True,
                       html_classes: str = "math_span") -> str:
  """
For inline math, use \(...\).
